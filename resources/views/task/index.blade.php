    ...
    <div class="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-4 p-4 gap-4">
        <div class="col-span-3">
            <div class="flex flex-col text-center w-full px-2 pb-2 bg-white">
                <h1 class="sm:text-xl text-lg title-font my-2 text-gray-800 text-center p-2 uppercase">Tasks</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Toutes les Tasks
                </p>
                <div class="w-full">
                            ...
                            @if (count($tasks) > 0)
                                @foreach ($tasks as $task)
                                     <tr>
                                        ...
                                        <td class="px-2 py-3 text-sm">{{ $task->name }}</td>
                             ...
                             {{-- @foreach ($categorys as $item)
                                      ...
                                      @endforeach --}}
                                        <td class="px-2 py-3 text-sm"> 
                                            <!-- DELETE using link -->
                                             {!! Form::open(['action' => ['TaskController@destroy', $task->id], 'method' => 'DELETE', 'id' => 'form-delete-users-' . $task->id, 'class' => 'flex']) !!}
                                            <a href="{{ route('task.destroy', $task->id) }}" class="left ">
                                            ...
                                            <a href="{{ route('task.edit', $task->id) }}" class="center">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 m-1" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div
                                            ...
                                            <button id="addTaskButtonLink" class="flex text-secondary">
        ...
        <div class="">
            <button id="addTaskButtonFileImg" class="bg-white h-auto p-4" type="button">
