    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 p-4 gap-4">
            <div class="col-span-2">
                ...
                <div class="flex items-center p-4 gap-4 bg-white shadow">
                    ...
                    <div class="mb-2 relative">
                        <label for="department" class="text-xs opacity-75 scale-75">Nom
                            du filiale</label>
                        {{ Form::text('subsName', $subs->subsName, ['autocomplete' => 'off','class' => 'peer border border-gray-200 focus:outline-none rounded focus:border-gray-500 focus:shadow-sm w-full py-1 px-2 h-8 placeholder-transparent text-sm', 'id' => 'department']) }}
                    </div>
                ...
                <div class="flex items-center p-4 gap-4 mt-4 bg-white shadow">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 p-4 gap-4 mt-4 bg-white shadow">
            ...
            <div class="flex flex-col px-6 py-5 bg-gray-50">
                ...
                <div class="mb-2 relative">
                    <label for="subsName" class="text-xs opacity-75 scale-75">Nom
                        du filiale</label>
                    {{ Form::text('subsName', '', ['autocomplete' => 'off','class' => 'peer border border-gray-200 focus:outline-none rounded focus:border-gray-500 focus:shadow-sm w-full py-1 px-2 h-8 placeholder-transparent text-sm', 'id' => 'subsName']) }}
                </div>
                {{ Form::submit('Envoyer', ['class' => 'flex text-white bg-gray-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-500 rounded']) }}
                {!! Form::close() !!}
            </div>
