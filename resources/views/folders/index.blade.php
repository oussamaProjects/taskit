    ...
    <div class="h-full ml-14 mt-14 mb-10 md:ml-64 p-4">
        ...
        <div class="grid grid-cols-6 lg:grid-cols-6 p-4 mb-6 mt-6 gap-4 bg-gray-50 shadow">
                                ...
                                @foreach ($folders as $folder)
                                    <li>
                                        ...
                                        @if (count($folder->children))
                                            ...
                                            @include('inc.manageChild2',['children' => $folder->children])
                                        @endif
                                    </li>
                                @endforeach
                            </ul>
            ...
            <div class="col-span-2 bg-gray-200">
                <div class="text-center mt-2 font-bold">Dossier</div>
                    ...
                    @if (count($folders_table) > 0)
                        @foreach ($folders_table as $folder)
                            <div id="tr_{{ $folder->id }}">
                                <div data-id="{{ $folder->id }}" class="max-w-xs mx-auto shadow relative"
                                    ...
                                    <div class="folder-container flex py-1 px-1 text-center align-middle">
                                        <div class="image">
                                        ...
                                        <div class="flex flex-col name px-2 text-left">
                                            ...
                                            <a href="/folder/{{ $folder->id }}/child"
                                                class="block text-sm font-bold text-gray-800 capitalize">
                                                {{ $folder->name }}
                                            </a>
                                            <div class="text-xs mt-autos">
                                                {{ $folder->created_at->toDayDateTimeString() }}
                                            </div>
                                        </div>


                                        <a href="#" class="right ml-auto show-action"
                                            data-form="folders-{{ $folder->id }}" class="flex items-center flex-1">
                                        ...
                                        <div
                                            ...
                                            <div class="colors flex flex-wrap" data-id="{{ $folder->id }}">
                                                <a href="" class="update_color_folder" data-color="#FFFFFF">
            ...
            <div class="col-span-3 bg-gray-200">
                <div class="text-center mt-2 font-bold">Fichier</div>
                <div class="grid grid-cols-3 lg:grid-cols-3 p-2 gap-4">
                    @if (!is_null($docs))
                        @foreach ($docs as $doc)
                            <div id="tr_{{ $doc->id }}">
