...
@section('content')
    ...
    <div class="flex flex-row flex-wrap my-2 mx-4 gap-4 p-4 bg-bg-color shadow-md">
        ...
        <div class="flex-initial border font-light shadow-sm">
        ...
        <div class="flex-1 border shadow-sm p-2">
            <div class="sm:text-xl text-lg font-medium title-font my-2 text-gray-800 text-center p-2 uppercase">
                Dans ce dossier <span class="text-secondary">{{ isset($folder) ? $folder->name : 'Root' }}</span>
        ...
        <div class="flex-1 border shadow-sm p-2">
            <div class="sm:text-xl text-lg font-medium title-font my-2 text-gray-800 text-center p-2 uppercase">Les documents
                dans <span class="text-secondary">{{ isset($folder) ? $folder->name : 'Root' }}</span></div>
