        ...
        <div class="col m11 s12">
            <div class="row">
                <h3 class="flow-text"><i class="material-icons">folder</i> folders
                    <a href="#" class="btn red waves-effect waves-light right tooltipped" data-position="left"
                        data-delay="50" data-tooltip="Delete Selected folders"><i class="material-icons">delete</i></a>
                    @can('upload')
