    ...
    <div class="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 p-4 gap-4">
        <div class="col-span-2 bg-white p-3">
            ...
            <div class="mb-8 relative">
                ...
                {{ Form::text('name', $folder->name, ['id' => 'name','autocomplete' => 'off','class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-8 text-sm bg-bg-color']) }}
            </div>

            @include('inc.folders.autorisation', ['subs' => $subs,'folder' => $folder])
        ...
        <div class="col-span-1">
            <button id="buttonmodalFolderImg" class="bg-white h-auto p-4" type="button">
