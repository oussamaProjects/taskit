            ...
            <div class="col-span-2">
                ...
                <div class="flex items-center p-4 gap-4">
                    ...
                    <div class="mb-5 relative">
                        {{ Form::text('name', $folder->name, ['class' => 'peer pt-8 border border-gray-200 focus:outline-none rounded-md focus:border-gray-500 focus:shadow-sm w-full p-3 h-16 placeholder-transparent', 'id' => 'folder']) }}
                        <label for="name"
