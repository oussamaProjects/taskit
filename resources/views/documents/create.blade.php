        ...
        <div class="col m11 s12">
            ...
            <div class="row">
                <div class="col m8 s12">
                    {!! Form::open(['action' => 'DocumentsController@store', 'method' => 'POST', 'enctype' =>
                    'multipart/form-data', 'class' => 'col s12']) !!}
                    {{ csrf_field() }}
                    <div class="card hoverable">
                        <div class="card-content">
                            ...
                            <div class="input-field">
                                <i class="material-icons prefix">class</i>
                                {{ Form::select('folder_id[]',$folders,null,['multiple' => 'multiple', 'id' => 'folder', 'placeholder' => 'Choose folder']) }}
