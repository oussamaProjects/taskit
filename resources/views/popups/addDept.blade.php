    ...
    <div
        ...
        <div class="overflow-y-scroll py-4 px-8">
            ...
            <div class="mb-2 relative">
                ...
                {{ Form::text('dptName', '', ['id' => 'dptName','autocomplete' => 'off','class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-10 text-sm']) }}
            </div>
            ...
            <div class="mb-4 relative">
                ...
                {{ Form::select('subs_id[]', $subs, null, ['id' => 'subs','class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-10 text-sm']) }}
                @if ($errors->has('subs'))
