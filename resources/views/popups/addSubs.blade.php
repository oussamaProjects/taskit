         ...
         <div class="overflow-y-scroll py-4 px-8">
             ...
             <div class="mb-4 relative">
                 <label for="subsName" class="text-xs opacity-75 scale-75">Nom
                     du filiale</label>
                 {{ Form::text('subsName', '', ['autocomplete' => 'off','class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-10 text-sm','id' => 'subsName']) }}
             </div>
