...
@section('content')
    ...
    <div class="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-4 p-4 gap-4">
                            ...
                            @if (count($projects) > 0)
                                @foreach ($projects as $project)
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-3 text-sm">
                                            {{-- {{ $project->estimate_time }} --}}
                                        </td>

                                        <td class="px-2 py-3 text-sm">
                                            {{-- {{ $project->estimate_value }} --}}
                                        </td>
                                        ...
                                        <td class="px-2 py-3 text-sm">
                                            <!-- DELETE using link -->
                                            {!! Form::open(['action' => ['ProjectController@destroy', $project->id], 'method' => 'DELETE', 'id' => 'form-delete-users-' . $project->id, 'class' => 'flex']) !!}
                                            <a href="{{ route('project.destroy', $project->id) }}" class="left ">
                                            ...
                                            <a href="{{ route('project.show', $project->id) }}"
                                                class="right data-delete" data-form="users-{{ $project->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 m-1" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div
                                            ...
                                            <button id="addprojectButtonLink" class="flex text-secondary">
        ...
        <div class="">
            <button id="addprojectButtonFileImg" class="bg-white h-auto p-4" type="button">
