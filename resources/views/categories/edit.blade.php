    ...
    <div id="modal"
        ...
        <div class="flex flex-col w-11/12 sm:w-5/6 lg:w-1/2 max-w-2xl mx-auto rounded-lg border border-bg-color shadow-xl">
            ...
            <div class="flex flex-col px-6 py-5 bg-bg-color">
                ...
                <div class="mb-2 relative">
                    {{ Form::text('name', '', ['autocomplete' => 'off','class' => 'peer border border-main focus:outline-none focus:border-secondary shadow focus:shadow-sm w-full py-1 px-2 h-10 text-sm', 'id' => 'category']) }}
