        ...
        <div class="col-span-2">
            ...
            <div class="flex items-center p-4 gap-4 bg-bg-color">
                ...
                <div class="mb-2 relative">
                    ...
                    {{ Form::text('name', $category->name, ['autocomplete' => 'off','class' =>'peer border border-main focus:outline-none focus:border-secondary shadow focus:shadow-sm w-full py-1 px-2 h-10 text-sm','id' => 'category']) }}
                </div>


                <div class="flex items-end justify-end">
                    {{ Form::submit('Sauvegarder les modifications', ['class' =>'flex text-bg-color bg-secondary hover:bg-main border-0 py-2 px-6 text-tiny focus:outline-none transition hover:bg-main ml-2']) }}
                </div>
