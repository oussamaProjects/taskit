<div class="tree px-2 py-4 text-xs text-main border bg-white shadow-md h-full">
                        ...
                        @if (count($folderTree->children))
                            <div class="open-folder">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="opened-folder h-3 w-3 absolute -right-5 top-1 cursor-pointer hidden" height=""
