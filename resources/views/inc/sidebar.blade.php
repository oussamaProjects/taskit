...
<div
    ...
    <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between">
        <ul class="flex flex-col py-4 space-y-1">
            ...
            @hasrole('Root')
            <li>
                <a href="{{route('taskTimeTracker')}}"
                    class="{{ request()->is('taskTimeTracker*') ? 'bg-secondary text-bg-color-800' : '' }} relative flex flex-row items-center h-7 focus:outline-none hover:bg-secondary text-bg-color-600 hover:text-bg-color-800 border-l-4 border-transparent hover:border-main pr-6">
                    <span class="inline-flex justify-center items-center ml-4">
                ...
                <li>
                    <a href="{{route('users.dashboad')}}"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Dashboad</span>
                        <span
