                ...
                @foreach ($folders as $folderTree)
                    <li>
                        <a href="\folders\{{ $folderTree->id }}"
                            ...
                            <div class="flex flex-row flex-wrap items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="{{ $folderTree->color }}"
                        ...
                        @if (count($folderTree->children))
                            <div class="open-folder">
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                    class="opened-folder h-3 w-3 absolute -right-5 top-1 cursor-pointer hidden" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 15l7-7 7 7" />
                                </svg>
