    ...
    <div class="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-4 p-4 gap-4">
        <div class="col-span-3">
            <div class="flex flex-col text-center w-full px-2 pb-2 bg-white">
                <h1 class="sm:text-xl text-lg title-font my-2 text-gray-800 text-center p-2 uppercase">Tous les Clients
                </h1>
                <div class="w-full">
                                ...
                                @foreach ($clients as $client)
                                    {{-- @if (!$client->hasRole('Root')) --}}
                                        <tr>
                                            ...
                                            <td class="px-2 py-3 text-sm">
                                                <!-- DELETE using link -->
                                                {!! Form::open(['action' => ['ClientController@destroy', $client->id], 'method' => 'DELETE', 'id' => 'form-delete-users-' . $client->id, 'class' => 'flex']) !!}
                                                <a href="#" class="left ">
                                                ...
                                                <a href="/client/{{ $client->id }}/edit" class="center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 m-1"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                <a href="" class="right data-delete" data-form="users-{{ $client->id }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 m-1"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                            ...
                            @else
                                <tr>
                                    <td colspan="4"> 
                                        ...
                                        No Client has been added
                                        <button id="addClientButtonLink" class="flex text-secondary">
        ...
        <div class="">
            <button id="addClientButtonFileImg" class="bg-white h-auto p-4" type="button">
