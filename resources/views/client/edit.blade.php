...
@section('content')
    ...
    <div class="flex flex-row flex-wrap p-4 mb-4 mt-2 w-1/2">
        ...
        {!! Form::open(['action' => ['ClientController@update', $client->id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data', 'class' => 'w-full']) !!}
        ...
        <div class="mb-2 relative">
            ...
            {{ Form::text('name', $client->name, ['autocomplete' => 'off','class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-8 text-sm bg-bg-color','id' => 'name']) }}
        ...
        <div class="mb-2 relative">
            ...
            {{ Form::text('address', $client->address, ['class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-8 text-sm bg-bg-color','id' => 'address']) }}
        </div>
        ...
        <div class="mb-2 relative">
            ...
            {{ Form::text('phone', $client->phone, ['class' =>'peer border border-main focus:outline-none focus:border-secondary shadow-sm focus:shadow-sm-sm w-full py-1 px-2 h-8 text-sm bg-bg-color','id' => 'address']) }}
        </div>
